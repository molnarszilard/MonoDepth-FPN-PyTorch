...
class NormalsDiff(nn.Module):
    ...
    def forward(self, fake, real):
        ...
        # o3d.io.write_point_cloud("/home/szilard/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/training_process_debug/python_cloud_normals003.pcd", real_pcd)
        # o3d.geometry.estimate_normals(real_pcd,search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=60,max_nn=30))
        # o3d.io.write_point_cloud("/home/szilard/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/training_process_debug/python_cloud_normals60.pcd", real_pcd)
        # o3d.io.write_point_cloud("/home/szilard/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/training_process_debug/python_cloud_pred.pcd", fake_pcd)
        # print(real)
        loss = np.mean(angle)
...
if __name__ == '__main__':
    ...
    # depth_test = cv2.imread("/home/szilard/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/combined_ir_d_d_debug/train/image.png",-1)
    # min_d_value = 100000
    # max_d_value = 0
...
#         lr = optimizer.param_groups[0]['lr']
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        save_dir = '/home/szilard/projects/MonoDepth-FPN-PyTorch/training_process/'
        ...
        for step in range(iters_per_epoch):
            ...
            if step % args.disp_interval == 0:
                # file_object = open("/home/szilard/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/results.txt", 'a')
...
#                                 % (epoch, step, loss, metric))
        ...
        if epoch%4 == 0 or epoch==args.max_epochs-1:
        ...
        with torch.no_grad():
            ...
            for i, data_eval in enumerate(eval_data_iter):
                ...
                if i==337:
                    ...
                    plt.colorbar()
                    plt.savefig('/home/szilard/projects/MonoDepth-FPN-PyTorch/training_process/gt_'+str(epoch)+'.png',bbox_inches='tight')
                    plt.close()

                    plt.imshow(z_fake[0].cpu().detach().numpy().transpose((1,2,0))*max_depth)#, vmin=vmin, vmax=vmax)
                    plt.colorbar()
                    plt.savefig('/home/szilard/projects/MonoDepth-FPN-PyTorch/training_process/pred_'+str(epoch)+'.png',bbox_inches='tight')
                    plt.close()

                # save_image(z_fake[0],'/home/szilard/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/vis_images/depth_pred_'+str(epoch)+'_'+'.png')
            ...
            file_object = open("/home/szilard/projects/MonoDepth-FPN-PyTorch/training_process/results.txt", 'a')
